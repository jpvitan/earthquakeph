        ...
        <div className='about-text-container text-center'>
            <div className='about-text-container-inner'>
                ...
                <div className='row justify-content-center mt-5'>
                    ...
                    <div className='col-auto'>
                        <a href='https://www.linkedin.com/in/justinepaulsanchezvitan/'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" className="bi bi-linkedin" viewBox="0 0 16 16" aria-label='LinkedIn'>
                    ...
                    <div className='col-auto'>
                        <a href='https://github.com/jpvitan'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16" aria-label='GitHub'>
                    ...
                    <div className='col-auto'>
                        <a href='https://twitter.com/jpvitan_dev'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" className="bi bi-twitter" viewBox="0 0 16 16" aria-label='Twitter'>
