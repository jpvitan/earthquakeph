        ...
        <div className='col my-auto' style={{ maxWidth: '35rem' }}>
          <div className='card border-0 shadow-sm px-3 py-4'>
            <div className='text-center'>
              ...
              <p className='version-text'>Version 2.3.0</p>
            </div>
            <p className='copyright-text'>This project is under the <a href='https://github.com/jpvitan/earthquakeph/blob/master/LICENSE'>MIT license</a>. Please read the terms and conditions stated within the license before attempting any modification or distribution of the software.</p>
            <p className='mb-0 copyright-text'>Developed and Designed by <a href='https://jpvitan.com/'>Justine Paul Sanchez Vitan</a>.</p>
            <p className='copyright-text'>Copyright © 2022 Justine Paul Sanchez Vitan. All rights reserved.</p>
          </div>
        </div>
      </div>
    </>
